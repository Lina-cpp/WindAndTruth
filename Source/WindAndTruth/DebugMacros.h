...
#define DRAW_POINT_SingleFrame(Location) if (GetWorld()) DrawDebugPoint(GetWorld(), Location, 20, FColor::Red, false, -1.f);
...
DrawDebugPoint(GetWorld(), EndLocation, 20, FColor::Red, false, -1.f); \
}
